...
from api.views import CommentListAPIView, CommentDetailAPIView,  MessageCreateAPIView
...
urlpatterns = [
    ...
    #path('consultant/messages/send/', ConsultantSendMessageAPIView.as_view(), name='send_message'),
    ...
    path('consultant/messages/create/', MessageCreateAPIView.as_view(), name='message-create'),
